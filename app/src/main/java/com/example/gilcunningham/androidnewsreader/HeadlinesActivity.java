...
import com.example.gilcunningham.androidnewsreader.view.NewsReaderViewPager;
import com.example.gilcunningham.androidnewsreader.view.adapter.PagerAdapter;
import com.example.gilcunningham.androidnewsreader.view.fragment.CategoriesFragment;
import com.example.gilcunningham.androidnewsreader.view.fragment.HeadlinesFragment;
import com.example.gilcunningham.androidnewsreader.view.fragment.SettingsFragment;
...
public class HeadlinesActivity extends AppCompatActivity implements NewsReaderCallback,
    ...
    public void onLoadMore(int nextPage) {
        ...
        if (STATE_TODAYS_ARTICLES == mReaderState) {
            NewsReaderService.newService(this, this)
                ...
                if (s.length() >= 3) {
                    ...
                    mSearchDelayTimer.schedule(new TimerTask() {
                        ...
                        public void run() {
                            ...
                            NewsReaderService.newService(HeadlinesActivity.this, HeadlinesActivity.this)
