...
import com.gc.newsreader.network.NewsReaderRestClient;
 ...
 */
public class NewsReaderService2 {

    private static final String TAG = "NewsReaderService2";
    ...
    public static NewsReaderService2 newService(Context context, NewsReaderCallback callback) {

        return new NewsReaderService2(context, callback);
    }

    private NewsReaderService2(Context context, NewsReaderCallback callback) {
        mContext = context;
        mCallback = callback;
    }
